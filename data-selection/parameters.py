...
neatnik.Parameters.splitting_priority = 1.8
...
neatnik.Parameters.altering_links = [0.2, 0.8]
neatnik.Parameters.altering_weight = [0.2, 0.7, 0.1]
neatnik.Parameters.adding_link = [0.4, 0.2, 0.2, 0.2, 0.]
neatnik.Parameters.enabling_node = [0.5, 0.0, 0.5]
